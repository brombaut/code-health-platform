async function fetchJson() {
    const response = await fetch("hierarchicalData.json");
...
const PADDING_LABEL = 0 // distance between edge end and engineer name
const BUBBLE_SIZE_MIN = 4
const BUBBLE_SIZE_MAX = 20

let diameter = 560;
let radius = diameter / 2;
let innerRadius = radius - 170; // between center and edge end
...
let label = svg.append("g").selectAll(".label");
let bubble = svg.append("g").selectAll(".bubble");
...
fetchJson().then((hierarchicalData) => {
